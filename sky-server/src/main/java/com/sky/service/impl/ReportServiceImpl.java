...
public class ReportServiceImpl implements ReportService {
    ...
    public TurnoverReportVO getTurnoverStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            // 查询date日期对应的营业额数据，营业额指状态为已完成的订单金额的合计
            LocalDateTime beginTime = LocalDateTime.of(date, LocalTime.MIN);
            LocalDateTime endTime = LocalDateTime.of(date, LocalTime.MAX);
            // select sum(amount) from orders where status = '已完成' and order_time > beginTime and order_time < endTime
            Map map = new HashMap();
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        List<Integer> newUserList = new ArrayList<>(); // 每日新增用户数
        List<Integer> totalUserList = new ArrayList<>(); // 每日总用户数
